    ...
    <>
        ...
        <section className="bg-siteBgColor text-slate-300">
            <div className="siteContainer">
                <h1 className="text-5xl pt-10 text-siteOrange">From Marketer to Developer</h1>
                <div className="flex flex-row items-center">
                    <p className="text-xl mt-10 w-[40rem] leading-8">
                    ...
                    <div className="">
                        <img className="w-[10rem] ml-20" src="/python_logo.png" alt="" />
                    </div>
                </div>
                <div className="flex flex-row mt-20 items-center">
                    <img className="w-64 mr-20" src="/closed_sign.png" alt="" />
                ...
                <div className="flex flex-row mt-20 items-center">
                    ...
                    <img className="w-64 ml-20" src="/white_dev_icon.png" alt="" />
                </div>
